"""
Random Forest baseline experiment v3 with shallow trees
...
# Run with shallow trees
with mlflow.start_run(run_name="random_forest_v3_shallow"):
    params = {
        'n_estimators': 50,
        'max_depth': 5,
    ...
    print("Training Random Forest v3 (shallow)...")
    ...
    mlflow.sklearn.log_model(model, "pattern_detection_model",
                            registered_model_name="sargen_random_forest_v3")
